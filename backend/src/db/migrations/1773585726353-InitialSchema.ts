...
export class InitialSchema1773585726353 implements MigrationInterface {
  name = 'InitialSchema1773585726353';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            CREATE TYPE "public"."background_jobs_status_enum" AS ENUM(
                'pending',
                'processing',
                'done',
                'failed',
    ...
    await queryRunner.query(`
            ...
            ADD CONSTRAINT "FK_5fb1428f4f64339bb2d4fd853b1" FOREIGN KEY ("vehicle_id") REFERENCES "vehicles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
    await queryRunner.query(
      `CREATE INDEX "IDX_maintenance_cards_vehicle_id" ON "maintenance_cards" ("vehicle_id")`,
    );
    await queryRunner.query(`
            ALTER TABLE "maintenance_histories"
            ADD CONSTRAINT "FK_c1ae546d5f00a7677c491c377b6" FOREIGN KEY ("maintenance_card_id") REFERENCES "maintenance_cards"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
    await queryRunner.query(
      `CREATE INDEX "IDX_maintenance_histories_card_id" ON "maintenance_histories" ("maintenance_card_id")`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX "IDX_maintenance_histories_card_id"`);
    await queryRunner.query(`
            ALTER TABLE "maintenance_histories" DROP CONSTRAINT "FK_c1ae546d5f00a7677c491c377b6"
        `);
    await queryRunner.query(`DROP INDEX "IDX_maintenance_cards_vehicle_id"`);
    await queryRunner.query(`
            ALTER TABLE "maintenance_cards" DROP CONSTRAINT "FK_5fb1428f4f64339bb2d4fd853b1"
        `);
    await queryRunner.query(`DROP INDEX "IDX_vehicles_user_id"`);
    await queryRunner.query(`
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            DROP TYPE "public"."background_jobs_status_enum"
        `);
    await queryRunner.query(`
            DROP TABLE "maintenance_histories"
        `);
    await queryRunner.query(`
            DROP TABLE "maintenance_cards"
        `);
    await queryRunner.query(`
            DROP TYPE "public"."maintenance_cards_type_enum"
        `);
    await queryRunner.query(`
            DROP TABLE "vehicles"
        `);
    await queryRunner.query(`
            DROP TYPE "public"."vehicles_mileage_unit_enum"
        `);
    await queryRunner.query(`
            DROP TABLE "users"
        `);
